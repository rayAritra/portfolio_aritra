...
const projects = [
  {
    title: 'NPM Package ',
    description: 'A CLI tool for scaffolding and publishing NPM packages with best practices.',
    ...
    github: 'https://github.com/rayAritra?tab=repositories'
  },
  {
    title: 'Music Vote Platform',
    description: 'A collaborative music platform where users vote on songs to determine the playlist order.',
